...
public class WriteMultipleBenchmark {

    // Each thread writes 1 object to space.
    @Benchmark
    public Object testWriteMultiple(SpaceState spaceState, ThreadState threadState) {
    ...
    public static class ThreadState {
        ...
        public void doTake(SpaceState spaceStat, ThreadParams threadParams) {
            spaceStat.gigaSpace.takeById(Message.class, String.valueOf(threadParams.getThreadIndex()));
        }
