...
public class TakeMultipleByTemplateMatchingOnIdBenchmark {

    // Each thread takes 1 object from space.
    @Benchmark
    public Object testTakeMultipleByTemplateMatchingOnId(SpaceState spaceState, ThreadState threadState) {
