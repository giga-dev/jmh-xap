...
public class TakeByIdsQueryBenchmark {

    @Benchmark
    public Object testTakeByIdsQuery(SpaceState spaceState, ThreadState threadState) {
        return spaceState.gigaSpace.takeByIds(new IdsQuery<Message>(Message.class, threadState.getThreadIds()));
    }
